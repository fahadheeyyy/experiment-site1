      ...
      <div className="contact-us">
        ...
        <div >
          <form className="contact-form" ref={form} onSubmit={sendEmail}>
            ...
            <input type="text" className="contact-input" name="user_name" placeholder="name"/>
            <div className="icon-image1">
              <img src={userImg} alt="" height="20px" width="20px" />
            </div>
            {/* <label>Email</label> */}
            <input type="email" className="contact-input" name="user_email" placeholder="e-mail"/>
            <div className="icon-image1">
        ...
        <div className="login-wrapper">
            <p>Want to go back?</p>
<button className="signup1-button"onClick={handleLoginChange1}>login</button>
        </div>
      </div>
    </div>
  );
